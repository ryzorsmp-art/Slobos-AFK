        ...
        <main>
          ...
          <div class="step-card">
            <div class="step-header">
              ...
              <h2 class="step-title">Configure Server</h2>
            </div>
            <ol>
              <li>Install <strong>Paper/Bukkit</strong> as your server software.</li>
              <li>Set <code>online-mode=false</code> and <code>enforce-secure-profile=false</code>.</li>
              <li>Install plugins: <code>ViaVersion</code>, <code>ViaBackwards</code></li>
            </ol>
          </div>
          ...
          <div class="step-card">
            ...
            <ol>
              <li>Edit <code>settings.json</code> with your server IP, port, and exact version.</li>
              <li>Upload all files to your <strong>GitHub Repository</strong>.</li>
            </ol>
          </div>
          ...
          <div class="step-card">
            <div class="step-header">
              ...
              <h2 class="step-title">Deploy & Run</h2>
            </div>
            <ol>
              <li>Deploy your bot repository on your hosting platform.</li>
              <li>Set the run command to <code>npm start</code>.</li>
              <li>The bot connects and auto-accepts server resource packs.</li>
            </ol>
          </div>
...
function createBot() {
  ...
  try {
    ...
    bot.on("resourcePack", (url, hash) => {
      addLog(`[ResourcePack] Server requested resource pack (${url.slice(0, 45)}...). Accepting...`);
      try {
        if (typeof bot.acceptResourcePack === "function") {
          bot.acceptResourcePack();
          addLog("[ResourcePack] [+] Successfully accepted resource pack!");
        }
      } catch (err) {
        addLog(`[ResourcePack] [-] Error accepting pack: ${err.message}`);
      }
    });
